...
import md from "../../asset/avater.png"
import cd from "../../asset/avater.png"
import it from "../../asset/avater.png"
import kotha from "../../asset/avater.png"
import bayazid from "../../asset/avater.png"
const Team = () => {
    return (
        <div>
            <div className=''>
        <div className="container flex justify-center mx-auto pt-16   ">
          <div>
            <p className="bg-clip-text text-transparent bg-gradient-to-r from-[#190D33] via-[#190D33] to-[#190D33] text-lg text-center font-bold pb-3">
              BUILDING TEAM
            </p>
            <h1 className="xl:text-4xl text-transparent text-3xl text-center bg-clip-text bg-gradient-to-r from-[#190D33] via-[#190D33] to-[#190D33] font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">
              The Talented People Behind the Scenes of the Organization
            </h1>
          </div>
        </div>
        <div className="w-full bg-gray-100 px-10 pt-10 bg-gradient-to-r from-[#190D33] via-[#190D33] to-[#190D33]">
          <div className="container mx-auto">
            <div className="lg:flex  md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
              <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                ...
                rounded overflow-hidden  shadow-2xl bg-gradient-to-r from-[#190D33] via-[#190D33] to-[#190D33]
              ...
              <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                <div className="rounded overflow-hidden shadow-md bg-gradient-to-r from-[#190D33] via-[#190D33] to-[#190D33]">
                  <div className="absolute -mt-20 w-full flex justify-center">
                    <div className="h-32 w-32">
                      <img
                        src={cd}
